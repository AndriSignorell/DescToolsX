...
#' order default is `"level"`. Character vectors are treated as unordered
#' factors. `desc.character()` converts `x` to a factor and then uses
...
#' 
#' @return an object of class `c("Desc.factor", "Desc")` containing
#' counts, frequency information, and metadata
#'
#' @seealso [pharos::plotCatDist()] for graphical display
#' 
