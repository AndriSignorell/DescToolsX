...
assoc_revo_cpp <- function(xR, yR, conf_level = 0.95) {
    .Call(`_DescToolsX_assoc_revo_cpp`, xR, yR, conf_level)
}
...
conDisPairsXY_indexed_full <- function(xR, yR) {
    .Call(`_DescToolsX_conDisPairsXY_indexed_full`, xR, yR)
}
