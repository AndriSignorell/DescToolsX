...
#' 
#' @param x a table. 
#' @param freq indicates, whether absolute or relative frenquencies should be
#' computed. Can either be \code{"abs"} or \code{"rel"}. Partial matching is
#' supported. 
#' @details
...
#' frequencies. 
#' @note This is a copy of the function \code{independence_table} in \pkg{vcd}.
