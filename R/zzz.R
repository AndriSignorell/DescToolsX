...
# nocov start
# .onLoad() runs when the namespace is loaded, before covr instruments the
# package, so it can never show up as covered. What it sets is checked in
# test-utils-internal.R instead.
